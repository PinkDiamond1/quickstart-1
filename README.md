# DigitalBits Quickstart Docker Image
...
```shell
$ docker run --rm -it -p "8000:8000" --name digitalbits docker.digitalbits.io/digitalbits-quickstart/digitalbits-quickstart:latest --testnet
```  
...
```shell
docker run --rm -it -p "8000:8000" -v "/home/scott/digitalbits:/opt/digitalbits" --name digitalbits docker.digitalbits.io/digitalbits-quickstart/digitalbits-quickstart:latest --testnet
```
...
```
$ docker run -d -p "8000:8000" --name digitalbits docker.digitalbits.io/digitalbits-quickstart/digitalbits-quickstart:latest --pubnet
```
...
$ docker run --rm -it \
    ...
    -p "11625:11625" \
    --name digitalbits \
    docker.digitalbits.io/digitalbits-quickstart/digitalbits-quickstart:latest --testnet
```
...
$ docker run -it --rm \
    ...
    --name digitalbits \
    docker.digitalbits.io/digitalbits-quickstart/digitalbits-quickstart:latest --pubnet
```
